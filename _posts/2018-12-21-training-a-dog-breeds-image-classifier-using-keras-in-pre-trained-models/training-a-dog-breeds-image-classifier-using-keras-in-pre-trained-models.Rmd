...
The Keras package will be used. Our classifier has reached 91% in validation.
...
The code for the one cycle policy callback is inspired by [this repository](https://github.com/titu1994/keras-one-cycle). Unfortunately, I have lost the original link to the original code of learning rate finder. =(
